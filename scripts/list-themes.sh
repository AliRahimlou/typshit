...
require_env THEME_STORE "Set SHOPIFY_THEME_STORE in .env so Shopify CLI knows which store to list themes from."
...
print_step "Listing Shopify themes"
"$SHOPIFY_BIN" theme list --store "$THEME_STORE"